...
\label{sec:SBT}
\textcolor{blue}{Like many other problems in combinatorial optimization, theoretical study of SMT requires abstraction and simplificatin of the real-world communication network.}
